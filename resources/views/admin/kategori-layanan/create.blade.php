...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('admin.kategori-layanan.store') }}" method="POST">
            @csrf
                ...
                <div class="row g-3">
                    <div class="">
                        ...
                        <input type="text" name="id_kategori" id="id_kategori"
                            class="form-control @error('id_kategori') is-invalid @enderror" value="{{ old('id_kategori') }}"
                    ...
                    <div class="">
                        ...
                        <input type="text" name="nama_kategori" id="nama_kategori"
                            ...
                            value="{{ old('nama_kategori') }}" required maxlength="100">
                        @error('nama_kategori')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
