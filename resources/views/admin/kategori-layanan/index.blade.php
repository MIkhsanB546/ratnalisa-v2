    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap gap-2 mb-3">
                <a href="{{ route('admin.kategori-layanan.create') }}" class="btn btn-sm btn-primary">
                    ...
                    <tbody>
                        @forelse ($kategoriLayanan as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.kategori-layanan.edit', $item) }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil-square" aria-hidden="true"></i>
                                        <span class="visually-hidden">Edit</span>
                                    </a>
                                    <form action="{{ route('admin.kategori-layanan.destroy', $item) }}" method="POST"
                                        class="d-inline"
